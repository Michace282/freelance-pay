            ...
            <div class="flex-column justify-content-between align-items-start">
                <div class = "deal__title d-flex align-items-center justify-content-between col-12" >
                    ...
                    <div class = "d-flex align-items-center col-3">
                             <button 
                        class="d-flex align-items-center justify-content-between form__btn fc-white scoped_arbit_button bc-secondary"
                        onclick="handleAction('{{ route('deal.arbitDeal', ['dealId' => $deal->id]) }}')"
                        >
                          Арбитраж
        ...
        <section class = "payments">
            <div class = "container-fluid p-0">
                ...
                <div class = "row justify-content-end">
                    ...
                    <div class = "row justify-content-center">
                        <div class = "text-center fc-secondary col-11 col-xl-8">
...
function handleAction(url) {
    ...
    .catch(error => console.error('Ошибка:', error));
     // Обновляем страницу с задержкой 500 мс
setTimeout(function () {
