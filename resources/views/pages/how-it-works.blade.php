            ...
            <div class = 'row'>
                <div class = "howScheme__items d-flex flex-wrap justify-content-center align-items-start col-12">
                    ...
                    <div class = "howScheme__item bc-akcent border-left fc-white d-flex flex-column align-items-center col-12 col-xl-4">
                        ...
                        <p>Если стороны не пришли к соглашению (услуга не соответствует заявленным характеристикам), то они могут прибегнуть к помощи опытных арбитражных консультантов  freelance-z.ru которые изучат суть спора и предложат сторонам возможные компромиссные решения.</p>
                    </div>
                    <div class = "howScheme__item bc-akcent border-left fc-white d-flex flex-column align-items-center col-12 col-xl-4">
                        <img src = "img/process5.svg" class = "align-self-end">
                        <h3>Статус «Завершенная сделка»</h3>
                        <p>Сделка успешно завершена. В случае выполнения обязательств перед заказчиком  freelance-z.ru переводит денежные средства на баланс исполнителя, при выявленном ненадлежащим исполнении условий сделки - возвращает заказчику. Сделка закрывается.</p>
                    </div>
                </div>
            </div>
        </div>
