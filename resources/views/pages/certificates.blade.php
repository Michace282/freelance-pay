        ...
        <div class = "container-fluid">
            ...
            <div class = "row">
                <div class = "head__description col-12 col-xl-6">
                    <p class = "text-center fc-main">Используйте наш сервис freelance-pay.com, не рискуя самостоятельно проверять человека на честность. Мошенник никогда и ни при каких условиях не согласиться проводить безопасную сделку.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class = "container-fluid">
            <div class = "row justify-content-center">
                <div class = "honest__description bc-akcent border-right fc-white text-center text-xl-start col-12 col-xl-8">
                    <p>Помните! <br>
                        Никогда не проверяйте человека на честность самостоятельно, так как риск потерять ваш товар очень и очень велик! Используйте гарант сервис freelance-pay.com. <br>
